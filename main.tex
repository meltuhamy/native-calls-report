...
\lstdefinelanguage{WebIDL}{
  keywords={any, boolean, byte, octet, unsigned, short, long, float, unrestricted, double, DOMString, object, interface, dictionary, enum, sequence},
  keywordstyle=\color{blue}\bfseries,
  ndkeywords={},
  ndkeywordstyle=\color{darkgray}\bfseries,
  identifierstyle=\color{black},
...
I would also like to than Petr Hosek for his ongoing enthusiasm, ideas, and engaging discussions about the project throughout the year.

Finally, I would like to thank my family and friends for their ongoing support throughout my degree.

\vspace{1em}
\epigraph{\emph{And say, ``My Lord, increase me in knowledge.''}}{\textup{Quran 20:114}}
