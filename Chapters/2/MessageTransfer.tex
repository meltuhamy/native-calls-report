...
<numbers type="array">
	...
	~\\
	Google Protocol Buffers are ``a language-neutral, platform-neutral, extensible way of serializing structured data for use in communications protocols, data storage, and more", according to the developer guide\footnote{\label{googleprotobuff}\lstinline+https://developers.google.com/protocol-buffers/docs/overview+}. They are used extensively within many Google products, including AppEngine\footnote{Google AppEngine is a Platform as a Service that allows developers to run their applications on the cloud}. 
...
cout << "E-mail: " << person.email() << endl;
	...
	Many RPC implementations which use protocol buffers exist. Although Java, C++, and Python are the languages that are officially supported, people have created open source  implementations for other languages, including JavaScript\footnote{\lstinline+https://github.com/dcodeIO/ProtoBuf.js+}.
\end{description}
