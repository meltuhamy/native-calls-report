...
\lstset{language=C,caption={JSON Schemas of WebIDL types},label=code_json_schema_webidl}
\begin{code}
{
...
\lstset{language=C,caption={JSON schema of a dictionary definition},label=code_json_schema_xyz_dictionary}
\begin{code}
{
  "name": "XYZ",
  "required": ["x","y","z"],
